      ...
      {values.map((d, i) => (
        <div key={i} className="flex items-center">
          <input
            ...
            onPaste={handlePaste}
            className={`${figtree.className} h-[51px] w-[48px] rounded-xl bg-primary-spectrum border border-gray-border text-center text-lg font-medium outline-none transition focus:border-primary-600 focus:ring-2 focus:ring-primary-100 font-medium`}
          />
