    ...
    <div>
      ...
      <div className="text-center">
        <button
          ...
          className="bg-primary disabled:cursor-not-allowed cursor-pointer sm:mt-10 mt-3 rounded-lg font-bold text-white hover:bg-dark-primary-2 w-full max-sm:text-sm py-3"
        >
