...
function MainPage() {
  ...
  const FirstSlideContent = () => (
    <div
      className="relative cursor-pointer md:bg-[url('/assets/Images/bg-section-1-cropped.webp')] bg-[url('/assets/Images/bg-section-1-mobile.webp')] bg-size-[100%_100%] bg-top bg-no-repeat text-white max-md:w-full max-md:aspect-1170/2205 md:w-full md:aspect-1920/1080"
